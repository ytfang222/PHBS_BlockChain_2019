...
public class BlockChainTest extends TestCase {
    ...
    @Test
    //Test01: Process a block with no transactions
    public void test01()
        ...
        System.out.println(bc.getMaxHeightBlock() == block1);
    }
    ...
    public void test02()
        ...
        System.out.println(bc.getMaxHeightBlock() == block1);
        System.out.println(bc.getMaxHeightUTXOPool().getAllUTXO().size());
    }
    ...
    public void test04()
        ...
        System.out.println(bc.getMaxHeightBlock() == createdBlock);
        System.out.println(bc.getMaxHeightUTXOPool().getAllUTXO().size() == 2);
    ...
    public void test05()
        ...
        System.out.println(bc.getMaxHeightBlock() == block6);
    }
    ...
    public void test06()
        ...
        Block block = new Block(genesisBlock.getHash(), pkB.getPublic());
        Tx tx1 = new Tx();
        TransactionPool txp = new TransactionPool();
        tx1.addInput(genesisBlock.getCoinbase().getHash(), 0);
        tx1.addOutput(25, pkB.getPublic());
        tx1.signTx(pkA.getPrivate(), 0);
        tx1.finalize();
        txp.addTransaction(tx1);
        System.out.println(txp.getTransactions().size() == 1);

        block.addTransaction(tx1);
        block.finalize();
        txp.removeTransaction(tx1.getHash());
        System.out.println(txp.getTransactions().size() == 0);
    }
    ...
    public void test07()
        ...
        System.out.println(bc.getMaxHeightBlock().getHash() == block1.getHash());
    }
    ...
    public void test09()
        ...
        block.finalize();
        System.out.println("Blocknew is ok: " + bh.processBlock(block));
    }
